...
% Slightly reduced leading to fit on one page
\linespread{0.93}
...
\begin{tikzpicture}[overlay,remember picture]
 \node[anchor=north west,inner sep=0pt]at ([xshift=17.0cm,yshift=-0.4cm]current page.north west) {\includegraphics[width=4cm]{me_cropped.jpg}};
\end{tikzpicture}

\begin{minipage}{15.8cm}
Founding Software Architect at Parahelp (YC S24) and ex-founder with a strong background in algorithms and high-performance systems, skilled at writing clean, correct, efficient code quickly. Fluent in English and Danish.
\end{minipage}
\vspace{-6pt}
...
\resumeSubHeadingListStart
  ...
  \resumeSubItem{AI agents}
    {\footnotesize{Building a production AI agent at Parahelp; also built full-stack agent apps using Lovable and LangGraph.}}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Founding Software Architect at Parahelp (YC S24)}{Nov. 2025 - present}
      {\footnotesize{Building the foundations of Parahelp's AI customer-support agent, used by companies such as Cursor, Lovable and Replit. Responsible for the agent, architecture, infrastructure, DevOps and full-stack development.}}{}
    \resumeSubheading
      {Co-founder of Dafnis ApS}{Aug. 2023 - Jun. 2025}
      {\footnotesize{A fully automated power trading firm, written in Rust, using ML and algorithms to trade power across Europe.}}{}
    \resumeSubheading
