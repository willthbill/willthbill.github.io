...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {A fully automated power trading firm using machine learning and algorithms to trade power across Europe. Utilizing a modern, high-performance tech stack, written in Rust.}{Dec. 2023 - present}
    \resumeSubheading
